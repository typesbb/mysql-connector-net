...
namespace MySql.Data.Entity
{
  class FunctionProcessor
  {
    ...
    static FunctionProcessor()
    {
      ...
      dateFunctions.Add("DiffDays", "TIMESTAMPDIFF(DAY, {0}, {1})");
      dateFunctions.Add("DiffHours", "TIMESTAMPDIFF(HOUR, {0}, {1})");
      dateFunctions.Add("DiffMicroseconds", "TIMESTAMPDIFF(MICROSECOND, {0}, {1})");
      dateFunctions.Add("DiffMinutes", "TIMESTAMPDIFF(MINUTE, {0}, {1})");
      dateFunctions.Add("DiffMonths", "TIMESTAMPDIFF(MONTH, {0}, {1})");
      dateFunctions.Add("DiffSeconds", "TIMESTAMPDIFF(SECOND, {0}, {1})");
      dateFunctions.Add("DiffYears", "TIMESTAMPDIFF(YEAR, {0}, {1})");
